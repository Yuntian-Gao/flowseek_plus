...
# python train.py --cfg config/train/Tartan-C368x496-"$SIZE".json --savedir checkpoints/ --restore_ckpt checkpoints/flowseek_"$SIZE"_Tartan_"$FS_PP".pth --fsPP $FS_PP
# python train.py --cfg config/train/Tartan-C-T432x960-"$SIZE".json --savedir checkpoints/ --restore_ckpt checkpoints/flowseek_"$SIZE"_TartanC_"$FS_PP".pth --fsPP $FS_PP
